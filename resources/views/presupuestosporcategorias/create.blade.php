@extends('layouts.app', ['activePage' => 'presupuestosprogramados', 'titlePage' => __('Presuspuesto Programado por
Categoria')])
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('monto') ? ' has-danger' : '' }}">
                                            ...
                                            @if ($errors->has('monto'))
                                                <span id="monto-error" class="error text-danger"
                                                    for="input-monto">{{                                                     for="input-monto">$errors->first('monto') }}</span>
                                            @endif
                                        </div>
                                    </div>
                                </div>
