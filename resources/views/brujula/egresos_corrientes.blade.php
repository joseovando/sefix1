<div class="col-lg-12 col-md-12">
    <div class="container-fluid">
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ModalEgresosCorrientes">
            + Nuevo Egreso Corriente
        </button>
    </div>
    <br>
    <div class="card">
        <div class="card-header card-header-primary">
            <h4 class="card-title">Egresos Corrientes</h4>
            <p class="card-category"></p>
        </div>
        {{-- <div class="card-body table-responsive"> --}}
        <div class="card-body table-responsive">
            <div class="">
                <table id="table_egresos_corrientes" class="display data-table" style="width:100%">
                    <thead>
                        <tr>
                            <th>Categoría</th>
                            <th>Cuenta</th>
                            ...
                            <tr>
                                ...
                                <td width="1%">
                                    <button class="btn btn-warning btn-fab btn-fab-mini" data-toggle="modal"
                                        data-target="#ModalEgresosCorrientes"
